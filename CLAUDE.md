...
| M2 | 🔶 In progress | Library & Reading UI (SwiftUI macOS) — import + RSVP wired; library/theme/flow-view not started; nothing compiler-verified yet. Security gate before exit: `F14`–`F19` ✅ all closed 2026-09-12; `F24` (Dependabot) still open before exit. |
