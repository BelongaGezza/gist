...
| **R7** | **Notarisation and Gatekeeper.** First-time notarisation with `libpdfium` reliably surfaces problems. | M | M | Throwaway end-to-end notarisation during M0. Prefer staticlib. Automate and run on every tag. Review entitlements explicitly in M3 `[A3]`. **Update 2026-09-24: `[A3]` done — ✅ closed 2026-09-18, see §3.10.** |
